...
<center>
![Python Windows installer 1](img/05-01_win.png)
</center>
...
!!! warning
    ...
    ![Python Windows installer 2](img/05-02_win.png)

Si todo salió correctamente debería ver una imagen similar a esta:

<center>
![Python Windows installer 3](img/05-03_win.png)
</center>
...
<center>
![Python Windows installer 4](img/05-04_win.png)

</center>
- Presionamos las teclas `win` + `R`, ponemos "cmd", presionamos `enter`.
<center>
![Python Windows installer 5](img/05-05_win.png)
</center>

Para cualquiera de las opciones nos tiene que abrir la siguiente ventana:

<center>
![Python Windows installer 6](img/05-06_win.png)
</center>
...
<center>
![Python Windows installer 7](img/05-07_win.png)
</center>
