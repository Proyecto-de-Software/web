...
-   :fontawesome-solid-book:{ .lg .middle } __Portal de Cátedras__
    ...
    [:octicons-arrow-right-24: Ir](https://catedras.linti.unlp.edu.ar/course/view.php?id=1353)
...
-   :fontawesome-brands-discord:{ .lg .middle } __Server de Discord__
    ...
    [:octicons-arrow-right-24: Ir](https://discord.gg/YQxy6yFtE)
...
-   :fontawesome-brands-gitlab:{ .lg .middle } __Repositorio de código__
    ...
    [:octicons-arrow-right-24: Ir](https://gitlab.catedras.linti.unlp.edu.ar/proyecto-2026/)
